...
//人機互動層類別
//CHCI_QM_panel: Class HumanComputerInteraction_QueryReservation_panel (人機介面-[查詢預約]操作畫面類別)
public class CHCI_QR_panel extends JPanel{
	...
	JTextField cond1txt=new JTextField();  //查詢輸入方快
	...
	//	setBackground(Color.yellow);
	 ...
	 private void setQuery2ComboBox(){
		 String[] items2={"姓名","電話","日期"};
		 qu2jcb = new JComboBox<>(items2);
	 ...
	 public String getSelectedQRStr(){
		 String str = "";
		 if(qu1jcb.getSelectedIndex()==0){
			 str = "RES_telephone";
		 }
		 if(qu1jcb.getSelectedIndex()==1){
			 str = "RES_name";
		 }
		 
		 if(qu1jcb.getSelectedIndex()==2){
			 str = "RES_date";	 
		 }
		 return str;
