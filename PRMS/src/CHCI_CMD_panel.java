...
//人機互動層類別
//CHCI_MMAO_panel: Class HumanComputerInteraction_PurchaseReport_panel (人機介面-[產生交易報表]操作畫面類別)
public class CHCI_CMD_panel extends JPanel{
	JPanel pane1=new JPanel();
	
	JLabel titleiconlbl=new JLabel();
	JLabel titlelbl=new JLabel("產生交易報表：");
	...
	CHCI_CMD_panel() {
		...
		pane1.setBackground(new Color(227, 242, 239));
        setBounds(0,65,1000,600);
        setLayout(null);
	}
