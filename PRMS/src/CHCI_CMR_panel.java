...
//人機互動層類別
//CHCI_CMR_panel: Class HumanComputerInteraction_MaterialsReport_panel (人機介面-[產生物料報表]操作畫面類別)
public class CHCI_CMR_panel extends JPanel{
	JPanel pane1=new JPanel();
	
	JLabel titleiconlbl=new JLabel();
	JLabel titlelbl=new JLabel("產生物料報表：");
